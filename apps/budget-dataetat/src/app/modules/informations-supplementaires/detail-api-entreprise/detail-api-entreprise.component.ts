...
export class DetailApiEntrepriseComponent {
  ...
  get label_ess() {
    return this.vueTribool(this.info?.quick.ess);
  }
  ...
  get label_rge() {
    ...
    return this.vueTribool(a_rge_active);
  }
  ...
  get label_qualibat() {
    ...
    return this.vueTribool(a_certif_qualibat);
  }
