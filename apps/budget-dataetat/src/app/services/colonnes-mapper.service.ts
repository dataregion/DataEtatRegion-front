...
export class ColonnesMapperService {
  ...
  private _print_code_label(c: Optional<string>, l: Optional<string>): string {
    const code = c ?? '';
    const label = l ?? '';
    return code !== '' ? `${code} - ${label}` : label;
  }

  private _print_localisation_interministerielle(loc: Optional<LocalisationInterministerielle>): string {
    let text = '';
    if (loc) {
      const code = loc.code;
  ...
  initService(colonnesTable: Colonne[], colonnesGrouping: Colonne[]): void {
    this.colonnes = [
      {
        name: this._colonnesTableau.BENEFICIAIRE.code,
      ...
      {
        name: this._colonnesTableau.MONTANT_AE.code,
        ...
        render: (row: FinancialDataModel) => row.montant_ae ? this._moneyFormat.format(row.montant_ae) : "",
        style: { 'min-width': '16ex', 'flex-grow': '0' }
      },
      {
        name: this._colonnesTableau.ANNEE_ENGAGEMENT.code,
      ...
      {
        name: this._colonnesTableau.MONTANT_CP.code,
        ...
        render: (row: FinancialDataModel) => row.montant_cp ? this._moneyFormat.format(row.montant_cp) : "",
        style: { 'min-width': '16ex', 'flex-grow': '0' }
      },
      {
        name: this._colonnesTableau.DOMAINE.code,
        ...
        render: (row: FinancialDataModel) => row.domaine_fonctionnel ? this._print_code_label(row.domaine_fonctionnel.code, row.domaine_fonctionnel.label) : ""
      },
      {
        name: this._colonnesTableau.COMMUNE.code,
      ...
      {
        name: this._colonnesTableau.CRTE.code,
      ...
      {
        name: this._colonnesTableau.EPCI.code,
      ...
      {
        name: this._colonnesTableau.ARRONDISSEMENT.code,
      ...
      {
        name: this._colonnesTableau.DEPARTEMENT.code,
      ...
      {
        name: this._colonnesTableau.REGION.code,
      ...
      {
        name: this._colonnesTableau.LOC_INTER.code,
        ...
        render: (row: FinancialDataModel) => this._print_localisation_interministerielle(row.localisation_interministerielle)
      },
      {
        name: this._colonnesTableau.N_EJ.code,
      ...
      {
        name: this._colonnesTableau.PROGRAMME.code,
        ...
        render: (row: FinancialDataModel) => this._print_code_label(row.programme?.code, row.programme?.label)
      },
      {
        name: this._colonnesTableau.REF_PROGRAMMATION.code,
        ...
        render: (row: FinancialDataModel) => this._print_code_label(row.referentiel_programmation?.code, row.referentiel_programmation?.label)
      },
      {
        name: this._colonnesTableau.CENTRE_COUTS.code,
        ...
        render: (row: FinancialDataModel) => this._print_code_label(row.centre_couts?.code, row.centre_couts?.description)
      },
      {
        name: this._colonnesTableau.SIRET.code,
      ...
      {
        name: this._colonnesTableau.QPV.code,
        ...
        render: (row: FinancialDataModel) => this._print_code_label(row.siret?.code_qpv, row.siret?.label_qpv)
      },
      {
        name: this._colonnesTableau.TYPE_ETABLISSEMENT.code,
      ...
      {
        name: this._colonnesTableau.COMPTE_BUDGETAIRE.code,
      ...
      {
        name: this._colonnesTableau.CPER.code,
      ...
      {
        name: this._colonnesTableau.GROUPE_MARCHANDISE.code,
        ...
        render: (row: FinancialDataModel) => this._print_code_label(row.groupe_marchandise?.code, row.groupe_marchandise?.label)
      },
      {
        name: this._colonnesTableau.DATE_DERNIER_PAIEMENT.code,
      ...
      {
        name: this._colonnesTableau.DATE_CREATION_EJ.code,
      ...
      {
        name: this._colonnesTableau.DATE_MODIFICATION.code,
      ...
      {
        name: this._colonnesTableau.DATA_SOURCE.code,
  ...
  public mapNamesFromPreferences(preferences: ColonneFromPreference[]): ColonneTableau<FinancialDataModel>[] {
    ...
    return filteredPrefs
      .map(pref => this.colonnes.find(c => c.name === pref.columnName))
