...
export class BaseService {
    ...
    public configuration: referentielsV3Configuration;
    public encoder: HttpParameterCodec;

    constructor(basePath?: string|string[], configuration?: referentielsV3Configuration) {
        this.configuration = configuration || new referentielsV3Configuration();
