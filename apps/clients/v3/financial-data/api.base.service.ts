...
export class BaseService {
    ...
    public configuration: financialDataV3Configuration;
    public encoder: HttpParameterCodec;

    constructor(basePath?: string|string[], configuration?: financialDataV3Configuration) {
        this.configuration = configuration || new financialDataV3Configuration();
