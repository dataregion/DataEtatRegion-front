...
export class BaseService {
    ...
    public configuration: dataQpvV3Configuration;
    public encoder: HttpParameterCodec;

    constructor(basePath?: string|string[], configuration?: dataQpvV3Configuration) {
        this.configuration = configuration || new dataQpvV3Configuration();
