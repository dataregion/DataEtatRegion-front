...
export interface dataQpvV3ConfigurationParameters {
    /**
...
export class dataQpvV3Configuration {
    /**
     *  @deprecated Since 5.0. Use credentials instead
     */
    apiKeys?: {[ key: string ]: string};
    ...
    constructor(configurationParameters: dataQpvV3ConfigurationParameters = {}) {
     ...
     * Uses {@link dataQpvV3Configuration#isJsonMime} to determine the correct content-type.
     ...
     * Uses {@link dataQpvV3Configuration#isJsonMime} to determine the correct accept content-type.
     * If no content type is found return the first found type if the contentTypes is not empty
