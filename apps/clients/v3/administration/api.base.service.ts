...
export class BaseService {
    ...
    public configuration: administrationV3Configuration;
    public encoder: HttpParameterCodec;

    constructor(basePath?: string|string[], configuration?: administrationV3Configuration) {
        this.configuration = configuration || new administrationV3Configuration();
