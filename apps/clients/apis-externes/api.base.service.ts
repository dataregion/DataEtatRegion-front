...
export class BaseService {
    ...
    public configuration: aeConfiguration;
    public encoder: HttpParameterCodec;

    constructor(basePath?: string|string[], configuration?: aeConfiguration) {
        this.configuration = configuration || new aeConfiguration();
