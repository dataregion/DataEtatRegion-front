...
export interface aev3ConfigurationParameters {
    /**
...
export class aev3Configuration {
    /**
     *  @deprecated Since 5.0. Use credentials instead
     */
    apiKeys?: {[ key: string ]: string};
    ...
    constructor(configurationParameters: aev3ConfigurationParameters = {}) {
     ...
     * Uses {@link aev3Configuration#isJsonMime} to determine the correct content-type.
     ...
     * Uses {@link aev3Configuration#isJsonMime} to determine the correct accept content-type.
     * If no content type is found return the first found type if the contentTypes is not empty
