...
export class BaseService {
    ...
    public configuration: aev3Configuration;
    public encoder: HttpParameterCodec;

    constructor(basePath?: string|string[], configuration?: aev3Configuration) {
        this.configuration = configuration || new aev3Configuration();
