...
import { BudgetServiceInterface } from './budget.serviceInterface';
...
export class BudgetService implements BudgetServiceInterface {
  ...
  constructor(
    ...
    @Optional() configuration: budgetConfiguration
  ) {
    if (configuration) {
   ...
   */
  public getBudgetCtrl(
    pageNumber?: string,
    limit?: string,
    nEj?: Array<string>,
    source?: string,
    codeProgramme?: Array<string>,
    niveauGeo?: string,
    codeGeo?: Array<string>,
    theme?: Array<string>,
    siretBeneficiaire?: Array<string>,
    typesBeneficiaires?: Array<string>,
    annee?: Array<number>,
    domaineFonctionnel?: Array<string>,
    referentielProgrammation?: Array<string>,
    tags?: Array<string>,
    observe?: 'body',
  ...
  ): Observable<PaginatedBudgetLines>;
  ...
  ): Observable<HttpResponse<PaginatedBudgetLines>>;
  ...
  ): Observable<HttpEvent<PaginatedBudgetLines>>;
  ...
  public getBudgetCtrl(
    ...
    if (nEj) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        [...nEj].join(COLLECTION_FORMATS['csv']),
        'n_ej'
      );
    }
    ...
    if (codeProgramme) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        [...codeProgramme].join(COLLECTION_FORMATS['csv']),
        'code_programme'
      );
    }
    ...
    if (codeGeo) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        [...codeGeo].join(COLLECTION_FORMATS['csv']),
        'code_geo'
      );
    }
    if (theme) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        [...theme].join(COLLECTION_FORMATS['csv']),
        'theme'
      );
    }
    if (siretBeneficiaire) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        [...siretBeneficiaire].join(COLLECTION_FORMATS['csv']),
        'siret_beneficiaire'
      );
    }
    if (typesBeneficiaires) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        [...typesBeneficiaires].join(COLLECTION_FORMATS['csv']),
        'types_beneficiaires'
      );
    }
    if (annee) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        [...annee].join(COLLECTION_FORMATS['csv']),
        'annee'
      );
    }
    if (domaineFonctionnel) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        [...domaineFonctionnel].join(COLLECTION_FORMATS['csv']),
        'domaine_fonctionnel'
      );
    }
    if (referentielProgrammation) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        [...referentielProgrammation].join(COLLECTION_FORMATS['csv']),
    ...
    return this.httpClient.request<PaginatedBudgetLines>(
      'get',
  ...
  ): Observable<HttpResponse<EnrichedFlattenFinancialLinesSchema>>;
  ...
  ): Observable<HttpEvent<EnrichedFlattenFinancialLinesSchema>>;
  ...
  public getGetBudgetCtrl(
    ...
    if (source === null || source === undefined) {
      throw new Error(
        'Required parameter source was null or undefined when calling getGetBudgetCtrl.'
      );
    }
    ...
    let localVarPath = `/budget/${this.configuration.encodeParam({
      name: 'source',
      value: source,
      in: 'path',
      style: 'simple',
    ...
    return this.httpClient.request<EnrichedFlattenFinancialLinesSchema>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
