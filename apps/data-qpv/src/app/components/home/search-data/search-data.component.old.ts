...
//     GeoLocalisationComponentService,
//   ],
//   imports: [CommonModule, ReactiveFormsModule, SelectMultipleComponent, LocalisationComponent, ModalAdditionalParamsComponent],
// })
...
//   public _searchParamsService = inject(SearchParamsService);
...
//     this.formSearch.controls.financeurs.setValue(data ?? null);
//   }
...
//     return this.formSearch.controls.porteurs.value ?? null;
//   }
//   set selectedPorteurs(data: Beneficiaire[] | null) {
//     this.formSearch.controls.porteurs.setValue(data ?? null);
//   }
...
//     return this.formSearch.controls.types_porteur.value ?? null;
//   }
//   set selectedTypesPorteur(data: SearchTypeCategorieJuridique[] | null) {
//     this.formSearch.controls.types_porteur.setValue(data ?? null);
//   }
...
//     this.formSearch = new FormGroup<FormSearch>({
...
//       qpvs: formValue.qpv || undefined,
//       financeurs: formValue.financeurs || undefined,
//       thematiques: formValue.thematiques || undefined,
//       porteurs: formValue.porteurs || undefined,
//       types_porteur: formValue.types_porteur || undefined,
//     };
...
//     //   localisations: this.selectedLocation,
...
//     // this._search_subscription = this._searchDataService
...
//       this.selectedLocation = preFilter.localisation as unknown as GeoModel[]
