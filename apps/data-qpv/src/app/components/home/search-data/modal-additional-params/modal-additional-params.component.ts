...
import { DsfrFormInputComponent, DsfrHeadingLevel, DsfrModalAction, DsfrModalComponent, DsfrSize, DsfrSizeConst } from "@edugouvfr/ngx-dsfr";
...
@Component({
    ...
    imports: [CommonModule, FormsModule, DsfrModalComponent, DsfrFormInputComponent]
})
